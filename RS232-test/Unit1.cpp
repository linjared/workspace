...
TFrom1 *From1;
//---------------------------------------------------------------------------
__fastcall TFrom1::TFrom1(TComponent* Owner)
	: TForm(Owner)
{

}
//---------------------------------------------------------------------------
void __fastcall TFrom1::BitBtn1Click(TObject *Sender)
{
  //宣告String變數使用
...
void __fastcall TFrom1::BitBtn2Click(TObject *Sender)
{
  //結束程式
 exit(0);
}
...
void __fastcall TFrom1::FormCreate(TObject *Sender)
{
 Comm1 ->PortOpen = true;
}
//---------------------------------------------------------------------------
